...
public class HKProgressBar extends ProgressBar {
    private static final String TAG = HKProgressBar.class.getSimpleName();
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mTextSize = HKProgressBar.sp2px(context, 10);
        mTextMargin = HKProgressBar.dp2px(context, 4);
        mReachedColor = Color.parseColor("#70A800");
        mReachedHeight = HKProgressBar.dp2px(context, 2);
        mUnReachedColor = Color.parseColor("#CCCCCC");
        mUnReachedHeight = HKProgressBar.dp2px(context, 1);
        mStartAngle = 0.0f;
        mIsCapRounded = false;
        mIsHiddenText = false;

        mRadius = HKProgressBar.dp2px(context, 16);
    }

    private void initCustomAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.HKProgressBar);
    ...
    private void onDrawCircle(Canvas canvas) {
        ...
        canvas.drawArc(mArcRectF, mStartAngle, sweepAngle, false, mPaint);
